...
bobo = DriveBase(motor_a_direito, motor_d_esquerdo, 48, 116)
...
def pararMotores():
    ...
    motor_d_esquerdo.stop
    motor_a_direito.stop
...
def girargraus(graus, direcao):
    ...
    if direcao == "esq":
        ...
        while giro() < (atual + graus):
            ...
            motor_d_esquerdo.dc(70)
            motor_a_direito.dc(-70)
...
def noventaverde():
    ...
    if checarcor(sensordecorEs()) == "verde" and checarcor(sensordecorDir()) != "verde":
        ...
        motor_d_esquerdo.run(720)
        motor_a_direito.run(-720)
